       ...
       <?php include '../includes/usernav.php';?>
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                <h3 class="mt-4">Upload Note</h3><hr>
                <!-- Page Heading -->
                <div class="row">
                    <div class="col-lg-12">
...
?>
	...
	<div class="form-group">
		...
		<input type="text" name="title" class="form-control" placeholder="Eg: Angular JS"  value = "<?php if(isset($_POST['upload'])) {
            echo $file_title; } ?>" required="">
	</div>

	<div class="form-group">
		<label for="post_tags">Short Note Description</label>
		<input type="text" name="description" class="form-control" placeholder="Eg: Angular JS ppt..." value="<?php if(isset($_POST['upload'])) {
...
<button type="submit" name="upload" style="background-color: #343c44;" class="btn btn-primary" value="Upload Note">Upload Note</button>
<br>
<br>
</form>
</div>
