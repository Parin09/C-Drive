       ...
       <?php include '../includes/usernav.php';?>
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <h3 class="mt-4">Welcome to your Profile</h3><hr>
                <div class="row">
                    <div class="col-lg-12">
...
<div class="form-group">
		...
		<br>
		<button type="submit" name="uploadphoto" class="btn btn-primary" value="upload photo" style="background-color: #343c44">upload photo</button>
    </div>
    </form>
...
<div class="form-group">
	...
	<div class="form-group">
		...
		<textarea  class="form-control" name="bio" id="" cols="30" rows="5"><?php  echo $bio;  ?>
		</textarea>
	</div>
...
<button type="submit" name="update" class="btn btn-primary" value="Update User" style="background-color: #343c44">Update User</button>
<br><br>
